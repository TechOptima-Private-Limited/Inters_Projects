...
#         # Bot message aligned to the left without icon
#         st.markdown(
#             f"""
...
# #     st.markdown("Excerpt from policy document used in responses:")
# #     st.code(content[:1000])  # Show snippet


# with col2:
#     st.subheader("🧪 Test Questions")

#     # Custom CSS to reduce space between list items
#     st.markdown("""
#         <style>
